...
class Uranus extends React.Component {
    ...
    getUranus = () => {
        axios.get(`https://api.le-systeme-solaire.net/rest/bodies/uranus`)
            .then(response => response.data)
            .then(data => {
                console.log('2', data);
                this.setState({
        ...
        return (
            <div className="">
                ...
                <div className="mob-12 ">
                    <img className="mob-12 font-avatar" src="https://sansible.fr/wp-content/uploads/2017/06/uranus_dawn_by_fokkusu1991-DeviantArt.png" alt="font-mars" />
...
export default connect(mapStateToProps)(Uranus);