...
class Jupiter extends React.Component {
    ...
    getImage = () => {
        axios.get(`https://images-api.nasa.gov/asset/PIA22946`)
    ...
    getJupiter = () => {
        axios.get(`https://api.le-systeme-solaire.net/rest/bodies/jupiter`)
            .then(response => response.data)
            .then(data => {
                console.log('2', data);
                this.setState({
        ...
        return (
            <div className="">
                ...
                <div className="mob-12 ">
                    <img className="mob-12 font-avatar" src="https://www.planete-astronomie.eu/files/photos/Jupiter/1-La-planete-Jupiter_Tache_Rouge/grande-tache-rouge-relief-3d.jpg" alt="font-mars" />
...
export default connect(mapStateToProps)(Jupiter);